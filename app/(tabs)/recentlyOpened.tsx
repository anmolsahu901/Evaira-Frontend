...
export default function RecentlyOpened() {
  ...
  // Defaulting to "Recently Opened" instead of "Recently Viewed"
  const [filter, setFilter] = useState<string>('Recently Opened');
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      console.log('[RecentlyOpened] Fetching products for filter:', filter);
  ...
  useFocusEffect(
    useCallback(() => {
      console.log('[RecentlyOpened] Screen focused, refreshing products');
      fetchProducts();
  ...
  const onRemove = async (productId: string | number) => {
    ...
    console.log('[RecentlyOpened] Remove action triggered for', productId, 'but not supported.');
  };
