...
export default function ProductCard({ product, onSave, onLike, onVisibilityChange, onViewDetails }: ProductCardProps) {
  ...
  // NOTE: Seen tracking is handled by the parent FlatList visibility callback,
  // because FlatList may mount adjacent items before they are actually visible.
    ...
    <View style={styles.cardContainer}>
      ...
      <Pressable style={styles.container} onPress={toggleOverlay}>
        ...
        <AnimatedLinearGradient
          colors={['rgba(0, 0, 0, 0.8)', 'rgba(0, 0, 0, 0.4)', 'rgba(0, 0, 0, 0.1)', 'rgba(0, 0, 0, 0)']}
          start={{ x: 0, y: 0 }}
          end={{ x: 0, y: 1 }}
